...
<head>
  ...
  <link href="<?php echo base_url()?>public/assets/vendor/modal-video/css/modal-video.min.css" rel="stylesheet">
...
<body>
  ...
  <header id="header" class="header">
    <div class="container">
      ...
      <div id="logo" class="pull-left">
        <h1><a href="<?php echo base_url()?>"><span>Nikita</span>Blog</a></h1>
  ...
  <section id="hero">
    <div class="hero-container" data-aos="fade-in">
      ...
      <img src="<?php echo base_url()?>public/assets/img/hero-img.png" alt="Hero Imgs" data-aos="zoom-out" data-aos-delay="100">
        ...
        <div class="row">
          ...
          <div class="col-md-6 col-lg-4" data-aos="zoom-in" data-aos-delay="100">
            <div class="feature-block">
              ...
              <img src="<?php echo base_url()?>public/assets/img/svg/cloud.svg" alt="img" class="img-fluid">
          ...
          <div class="col-md-6 col-lg-4" data-aos="zoom-in" data-aos-delay="200">
            <div class="feature-block">
              ...
              <img src="<?php echo base_url()?>public/assets/img/svg/planet.svg" alt="img" class="img-fluid">
          ...
          <div class="col-md-6 col-lg-4" data-aos="zoom-in" data-aos-delay="300">
            <div class="feature-block">
              ...
              <img src="<?php echo base_url()?>public/assets/img/svg/asteroid.svg" alt="img" class="img-fluid">
      ...
      <div class="container" data-aos="fade-up">
        <div class="row justify-content-center">
          ...
          <div class="col-md-5 col-lg-3">
            <img src="<?php echo base_url()?>public/assets/img/about-img.png" alt="About" data-aos="zoom-in" data-aos-delay="100">
          </div>
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row" data-aos="fade-up" data-aos-delay="100">
          ...
          <div class="col-md-6 col-lg-3">
            <div class="feature-block">
              <img src="<?php echo base_url()?>public/assets/img/svg/paint-palette.svg" alt="img" class="img-fluid">
          ...
          <div class="col-md-6 col-lg-3">
            <div class="feature-block">
              <img src="<?php echo base_url()?>public/assets/img/svg/design-tool.svg" alt="img" class="img-fluid">
              <h4>easy to use</h4>
              <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry</p>
            </div>
          </div>
          ...
          <div class="col-md-6 col-lg-3">
            <div class="feature-block">
              <img src="<?php echo base_url()?>public/assets/img/svg/cloud-computing.svg" alt="img" class="img-fluid">
          ...
          <div class="col-md-6 col-lg-3">
            <div class="feature-block">
              <img src="<?php echo base_url()?>public/assets/img/svg/pixel.svg" alt="img" class="img-fluid">
              <h4>Perfect Pixel</h4>
              <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry</p>
            </div>
          </div>
          ...
          <div class="col-md-6 col-lg-3">
            <div class="feature-block">
              <img src="<?php echo base_url()?>public/assets/img/svg/code.svg" alt="img" class="img-fluid">
              <h4>clean codes</h4>
              <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry</p>
            </div>
          </div>
    ...
    <section id="screenshots" class="padd-section text-center">
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="owl-carousel owl-theme" data-aos="fade-up" data-aos-delay="100">
          ...
          <div><img src="<?php echo base_url()?>public/assets/img/screen/1.jpg" alt="img"></div>
          <div><img src="<?php echo base_url()?>public/assets/img/screen/2.jpg" alt="img"></div>
          <div><img src="<?php echo base_url()?>public/assets/img/screen/3.jpg" alt="img"></div>
          <div><img src="<?php echo base_url()?>public/assets/img/screen/4.jpg" alt="img"></div>
          <div><img src="<?php echo base_url()?>public/assets/img/screen/5.jpg" alt="img"></div>
          <div><img src="<?php echo base_url()?>public/assets/img/screen/6.jpg" alt="img"></div>
          <div><img src="<?php echo base_url()?>public/assets/img/screen/7.jpg" alt="img"></div>
          <div><img src="<?php echo base_url()?>public/assets/img/screen/8.jpg" alt="img"></div>
          <div><img src="<?php echo base_url()?>public/assets/img/screen/9.jpg" alt="img"></div>
        ...
        <div class="row">
          ...
          <div class="col-md-6 col-md-4 col-lg-3" data-aos="zoom-in" data-aos-delay="100">
            <div class="team-block bottom">
              <img src="<?php echo base_url()?>public/assets/img/team/1.jpg" class="img-responsive" alt="img">
          ...
          <div class="col-md-6 col-md-4 col-lg-3" data-aos="zoom-in" data-aos-delay="200">
            <div class="team-block bottom">
              <img src="<?php echo base_url()?>public/assets/img/team/2.jpg" class="img-responsive" alt="img">
              <div class="team-content">
                <ul class="list-unstyled">
                  <li><a href="#"><i class="fa fa-facebook"></i></a></li>
                  <li><a href="#"><i class="fa fa-twitter"></i></a></li>
          ...
          <div class="col-md-6 col-md-4 col-lg-3" data-aos="zoom-in" data-aos-delay="300">
            <div class="team-block bottom">
              <img src="<?php echo base_url()?>public/assets/img/team/3.jpg" class="img-responsive" alt="img">
              <div class="team-content">
                <ul class="list-unstyled">
                  <li><a href="#"><i class="fa fa-facebook"></i></a></li>
                  <li><a href="#"><i class="fa fa-twitter"></i></a></li>
          ...
          <div class="col-md-6 col-md-4 col-lg-3" data-aos="zoom-in" data-aos-delay="400">
            <div class="team-block bottom">
              <img src="<?php echo base_url()?>public/assets/img/team/4.jpg" class="img-responsive" alt="img">
              <div class="team-content">
                <ul class="list-unstyled">
                  <li><a href="#"><i class="fa fa-facebook"></i></a></li>
                  <li><a href="#"><i class="fa fa-twitter"></i></a></li>
        ...
        <div class="row" data-aos="fade-up" data-aos-delay="100">
          ...
          <div class="col-md-6 col-lg-4">
            <div class="block-blog text-left">
              <a href="#"><img src="<?php echo base_url()?>public/assets/img/blog/blog-image-1.jpg" alt="img"></a>
          ...
          <div class="col-md-6 col-lg-4">
            <div class="block-blog text-left">
              <a href="#"><img src="<?php echo base_url()?>public/assets/img/blog/blog-image-2.jpg" class="img-responsive" alt="img"></a>
              <div class="content-blog">
                <h4><a href="#">whats isthe difference between good and bat typography</a></h4>
                <span>05, juin 2017</span>
                <a class="pull-right readmore" href="#">read more</a>
          ...
          <div class="col-md-6 col-lg-4">
            <div class="block-blog text-left">
              <a href="#"><img src="<?php echo base_url()?>public/assets/img/blog/blog-image-3.jpg" class="img-responsive" alt="img"></a>
              <div class="content-blog">
                <h4><a href="#">whats isthe difference between good and bat typography</a></h4>
                <span>05, juin 2017</span>
                <a class="pull-right readmore" href="#">read more</a>
  ...
  <script src="<?php echo base_url()?>public/assets/vendor/modal-video/js/modal-video.min.js"></script>
